...
export default class TransactionListScreenCustomer extends Component {
  constructor(props){
    super(props);
    ...
    return (
      ...
      <Container>
        ...
        <TransactionList clients={this.state.clients}  onPress={(token) => {
          this.props.navigation.navigate('TransactionScreenCustomer', {
        ...
        <Footer>
          <FooterTab>
            <Button ounded onPress={() => this.props.navigation.navigate('ScanScreenCustomer')}>
              <Text>QR Scan</Text>
            </Button>
          </FooterTab>
        </Footer>
